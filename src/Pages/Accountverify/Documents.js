                    ...
                    {data.map((doc,i) =>
                        <tr>
                            ...
                            <td>
                                ...
                                {
                                    doc.status === 'Pending' ?
                                    <a href="javascript::void(0)" onClick={(e)=>deleteDocument(e,doc.id)} className="delete-icon"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
