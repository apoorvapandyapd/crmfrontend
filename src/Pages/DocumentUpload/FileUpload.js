...
function FileUpload(props, ref) {
    ...
    useEffect(() => {
        if (props.data !== null && props.data.extension == "pdf") {
            ...
            props.displayStatus !== "Rejected" &&
            props.displayStatus !== "Pending"
        ) {
  ...
  if (props.displayStatus === "Approved") {
    ...
    displayStatus = (
      <span className="text-danger">Rejected ({props.data.comment})</span>
    );
    status = "Rejected";
                            ...
                            {props.displayStatus !== "Approved" ? (
                                <>
                                    <div className="file-upload-text">
                                        <p>
                                            Provide files in jpg, jpeg, png, gif, svg or pdf format,
                                            10 MB maximum.
                                        </p>
                                    </div>
                                </>
                    ...
                    (props.displayStatus!='Approved' && props.side==2) ? '(You need to upload the front and back sides, otherwise it can be rejected)' : ''
                        ...
                        <div className="file-upload-image">
                            {props.data !== null && props.data.extension != "pdf" ? (
                                <a
                                    href="#"
                                    onClick={(e) => showModal(e, previewFront)}
                                >
                                    <img
                                        src={
                                            previewFront != null
                                ...
                                <a
                                    href={props.data !== null && props.data.image_path}
                                    target="_blank"
                                >
                                    <img
                                        src={
                            ...
                            {status !== "Not uploaded" ? (
                                <span
                                    ...
                                    onClick={closeFront}
                                >
                                    <MultiplyIcon width="24" height="24" />
                </span>
                            ) : (
                                <span></span>
                            )}
              ...
              >
                {pwdState === false ? (
                        ...
                        <small className="text-danger">
                            {props.error !== null ? props.error.map((val) => val.front) : ""}
                        </small>
                    </div>
                }
            </div>
