                                ...
                                <div className='p-40'>
                                        ...
                                        {data !== null ?
                                            <>
                                                <div className="form-group col-6 col-sm-3">
                                                    <FormControl type="radio" value={data.payment_method} checked
                                                                 data-name={data.payment_name} name="account_group_id"
                                                                 id={data.payment_method}/>
                                                    <label htmlFor={data.payment_method}><img src={data.logo} alt=""/><p
                                                        className='text-center mt-2 pb-2'>{data.payment_method}</p>
                                                    </label>
                                                </div>
                                            </> : ''}
                                    </div>
                                    ...
                                    <form onSubmit={submitPaymentGroup} id='editPaymentForm'>
                                                        ...
                                                        <Col md={6} className="mt-3">
                                                            {val.type != 'textarea' ? <><label>{val.label}</label>
                                                                    <input type={val.type} className='form-control'
                                                                           name={val.key} id={val.key} value={value[val.key]}
                                                                           placeholder={val.label} onChange={handleInput}/></>
                                                                : <><label>{val.label}</label><FormControl as="textarea"
                                                                                                           name={val.key}
                                                                                                           value={value[val.key]}
                                                                                                           id={val.key}
                                        ...
                                        <div
                                            ...
                                            <button type="submit"
                                                    className="btn btn-primary float-end btn btn-primary mb-3 mb-sm-0 order-1 order-sm-0">Update
                                            </button>
                                        </div>
                                    </form>
                                </div>
