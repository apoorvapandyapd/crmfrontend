                                ...
                                <div className='box-wrapper'>
                                    <div className='card-body create-ticket p-0 bg-white'>
                                        <h2 className="mb-0 px-40">
                                            <Link to='/accountverification'><a href="#"
                                                ...
                                                <div className="row">
                                                        ...
                                                        <div className="upload-id">
                                                            ...
                                                            <div className="file-upload mt-3">
                                                                ...
                                                                <div className="file-upload-image">
                                                                    <img src={previewFront} className='mt-3' alt=""
                                                                         width="100%"/>
                                                                    <span className="close-icon" onClick={closeFront}><svg
                                                                ...
                                                                <div className="file-upload-text">
                                                                    {/* <h4>Front side</h4> */}
                                                                    <p>Provide files in jpg, jpeg, png, gif, svg or pdf
                                                                        format, 5 MB maximum.</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div className="content">
                                                            <p>The document you are providing must be valid at least 30
                                                                days and contain all of the following details</p>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div className="vr-item">
                                                                <svg width="18" height="18" viewBox="0 0 18 18"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        fill="#2FD614"/>
                                                                    <path
                                                                        d="M7.93508 11.685C7.78508 11.685 7.64258 11.625 7.53758 11.52L5.41508 9.39751C5.19758 9.18001 5.19758 8.82001 5.41508 8.60251C5.63258 8.38501 5.99258 8.38501 6.21008 8.60251L7.93508 10.3275L11.7901 6.47251C12.0076 6.25501 12.3676 6.25501 12.5851 6.47251C12.8026 6.69001 12.8026 7.05001 12.5851 7.26751L8.33258 11.52C8.22758 11.625 8.08508 11.685 7.93508 11.685Z"
                                                                        fill="#2FD614"/>
                                                                </svg>
                                                                <p className="vr-item-text">Upload a colourful full-size
                                                                    (4 sides visible) photo of the document.</p>
                                                            </div>
                                                            <div className="vr-item">
                                                                <svg width="18" height="18" viewBox="0 0 18 18"
                                                                     fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path
                                                                        ...
                                                                        fill="#D61414"/>
                                                                    <path
                                                                        d="M6.87752 11.685C6.73502 11.685 6.59252 11.6325 6.48002 11.52C6.26252 11.3025 6.26252 10.9425 6.48002 10.725L10.725 6.48002C10.9425 6.26252 11.3025 6.26252 11.52 6.48002C11.7375 6.69752 11.7375 7.05752 11.52 7.27502L7.27502 11.52C7.17002 11.6325 7.02002 11.685 6.87752 11.685Z"
                                                                        fill="#D61414"/>
                                                                    <path
                                                                        d="M11.1225 11.685C10.98 11.685 10.8375 11.6325 10.725 11.52L6.48002 7.27502C6.26252 7.05752 6.26252 6.69752 6.48002 6.48002C6.69752 6.26252 7.05752 6.26252 7.27502 6.48002L11.52 10.725C11.7375 10.9425 11.7375 11.3025 11.52 11.52C11.4075 11.6325 11.265 11.685 11.1225 11.685Z"
                                                                        fill="#D61414"/>
                                                                </svg>
                                                                <p className="vr-item-text">Do not upload selfies,
                                                                    screenshots and do not modify the images in graphic
                                                                    editors.</p>
                                                            </div>
                                                        </div>
                                                        <div
                                                            ...
                                                            <button type="submit"
                                                                    className="btn btn-primary float-end btn btn-primary mb-3 mb-sm-0 order-1 order-sm-0">Submit
                                                                request
                                                            </button>
                                                        </div>
                                                    </div>
