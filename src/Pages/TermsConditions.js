...
const TermsConditions=(props)=>{
    ...
    async function fetchData() {
      try {
          ...
          await axios.post(TERMS_API_URL, bodyParameters, config).then((res)=>{
            ...
            <div className='list-point'>
                <ul>
                    ...
                    <div className="form-check mt-5">
                        <input type="checkbox" className="form-check-input" id="exampleCheck1" onChange={() => setChecked(!checked)} />
                        <label className="form-check-label" for="exampleCheck1">BY ACCEPTING, THE CLIENT AGREES TO BE LEGALLY BOUND BY THE TERMS AND CONDITIONS OF THE CLIENT AGREEMENT.</label>
            </div>
                    ...
                    canvasProps={{width: '800px', height: '300px', className: 'sigCanvas'}} />
                    </div>
