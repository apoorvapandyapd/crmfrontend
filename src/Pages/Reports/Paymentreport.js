...
const Paymentreport = () => {
    ...
    async function fetchData(date_from, date_to) {
        ...
        try {
            ...
            await axios.post(PAYEMNT_REPORT_API, formData, config).then(res => {
    ...
    const downloadReport=async(e)=>{
        ...
        try {
            ...
            let urls = DOWNLOAD_REPORT_API+'/'+client.client.id+'/'+fromDate+'/'+toDate;
            ...
            <Innerlayout>
                                    ...
                                    <Row>
                                        ...
                                        <Col md={4}>
                                            <FormGroup className="mb-3">
                                                ...
                                                <FormControl type="date" max={todayDt} className="uppercase-date" name="date_from" placeholder="dd-mm-yyyy" required />
                                            </FormGroup>
                                        </Col>
                                        <Col md={4}>
                                            <FormGroup className="mb-3">
                                                <label>Date To</label>
                                                <FormControl type="date" max={todayDt} className="uppercase-date" name="date_to" placeholder="Date TO" required />
                                            </FormGroup>
                                        </Col>
                                        <Col md={4}>
                ...
                {reportdata === null && loading === true ? <PropagateLoader
                    ...
                    <div className="card-body table-last-col">
                        ...
                        reportdata!==null && 
                        <>
                                <Link to="#" style={{ cursor: 'pointer' }} className="btn btn-primary float-end mb-3" onClick={(e) => downloadReport(e)}>Export PDF</Link>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Transfer</th>
                                                {(client.client.ib_status === 'both') ? <th scope="col">IB Commission</th> : null}
                                    ...
                                    {reportdata.map((data, i) =>
                                        <tr>
                                            ...
                                            <td>
                                            {
                                                ...
                                                <span className="text-danger">{data.transfer}</span> : <span className="text-success">{data.transfer}</span> : null
                                            }
                                            </td>
                                            {
                                                ...
                                                <td>
                                                {
                                                    ...
                                                    <span className="text-success">{data.commission}</span> : ''
                                                }
                                                </td> : null
                                            }
