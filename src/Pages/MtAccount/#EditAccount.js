...
const EDIT_MT_ACCOUNT_API = base_url+"/v1/client/edit-mtaccount";
                        ...
                        <div className="box-wrapper w-700">
                            ...
                            <div className='p-40'>
                                <form onSubmit={editSubmitForm}>
                                    ...
                                    {/* <Form.Group className="mb-3"> 
                                        <input type="text" className="form-control" value={value.account_type_id} readOnly/>
                                    </Form.Group> */}
                                    {/* <Form.Group className="mb-4">
                                        <select className="form-control select" name='account_group_id' value={value.account_group_id} onChange={handleInput}>
