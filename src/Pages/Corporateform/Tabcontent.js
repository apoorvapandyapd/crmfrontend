...
const Tabcontent = () => {
    ...
    // const [director_option] = useState(null);
    ...
    // const [signatureCanvases, setSignatureCanvases] = useState([]);
    ...
    const phoneChanger = (value, country, field, formattedValue, i, key) => {
        ...
        if (key === 'company') {
            ...
            authData[key.sub_type][key.field] = value.replace(country.dialCode, `+${country.dialCode} `);
            ...
            <div className="form-left">
                <ul className="nav-tabs" id="myTab" role="tablist">
                    ...
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'company' ? 'active disabled' : 'disabled'} id="tab-2" data-bs-toggle="tab" data-bs-target="#tab-pane-2" role="tab" aria-controls="tab-pane-2" aria-selected="false">Company Information</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'sole' ? 'active disabled' : 'disabled'} id="tab-3" data-bs-toggle="tab" data-bs-target="#tab-pane-3" role="tab" aria-controls="tab-pane-3" aria-selected="false">Details of Directors</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'ubo' ? 'active disabled' : 'disabled'} id="tab-4" data-bs-toggle="tab" data-bs-target="#tab-pane-4" role="tab" aria-controls="tab-pane-4" aria-selected="false">Details of Shareholders</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'auth' ? 'active disabled' : 'disabled'} id="tab-5" data-bs-toggle="tab" data-bs-target="#tab-pane-5" role="tab" aria-controls="tab-pane-5" aria-selected="false">Details of Person(s) Authorised to operate the Account.</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'banking' ? 'active disabled' : 'disabled'} id="tab-6" data-bs-toggle="tab" data-bs-target="#tab-pane-6" role="tab" aria-controls="tab-pane-6" aria-selected="false">Banking Details</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'income' ? 'active disabled' : 'disabled'} id="tab-7" data-bs-toggle="tab" data-bs-target="#tab-pane-7" role="tab" aria-controls="tab-pane-7" aria-selected="false">Income Information</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'trading' ? 'active disabled' : 'disabled'} id="tab-8" data-bs-toggle="tab" data-bs-target="#tab-pane-8" role="tab" aria-controls="tab-pane-8" aria-selected="false">Trading Experience and Knowledge</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'fund' ? 'active disabled' : 'disabled'} id="tab-9" data-bs-toggle="tab" data-bs-target="#tab-pane-9" role="tab" aria-controls="tab-pane-9" aria-selected="false">Source of funds</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'disclosure' ? 'active disabled' : 'disabled'} id="tab-10" data-bs-toggle="tab" data-bs-target="#tab-pane-10" role="tab" aria-controls="tab-pane-10" aria-selected="false">General Disclosure</Link>
                </li>
                    <li className="nav-item" role="presentation">
                        <Link className={state === 'declaration' ? 'active disabled' : 'disabled'} id="tab-11" data-bs-toggle="tab" data-bs-target="#tab-pane-11" role="tab" aria-controls="tab-pane-11" aria-selected="false">Declarations</Link>
                </li>
        ...
        <div className="form-right">
            <div className="tab-content" id="myTabContent">
                ...
                <Directors onSubmit={onSubmit} phoneChanger={phoneChanger} directorData={directorData} onChangeDirectorData={onChangeDirectorData} countryChange={onChangeDirectorCountry} addDirectorForm={addDirectorForm} removeDirectorForm={removeDirectorForm} error={error} curState={state} backChanger={backEvent} fillLater={fillLater} />
                    <Comanyinfo onSubmit={onSubmit} disableSaveBtn={disableSaveBtn} phoneChanger={phoneChanger} handleChanger={handleChanger} data={data} countryChange={selectChange} error={error} curState={state} backChanger={backEvent} fillLater={fillLater} />
