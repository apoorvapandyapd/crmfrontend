...
function ClientTransferTable(props) {
    ...
    const currentRecords = transfer.slice(indexOfFirstRecord, indexOfLastRecord);
    const nPages = Math.ceil(transfer.length / recordsPerPage);
                    ...
                    <div className="card-body table-last-col p-0">
                        ...
                        <div className="table-responsive mt-3 mt-lg-0">
                            <Table className="table m-0 align-middle">
                                ...
                                <tbody>
                                        {currentRecords.length === 0 ? <tr><td colspan="6">No records found</td></tr> : currentRecords.map((transfer, i) =>
                                            <tr>
                            ...
                            {
                                transfer.length > TBL_SHOW_RECORDS ?
                                    <Pagination
                                        nPages={nPages}
...
export default ClientTransferTable
