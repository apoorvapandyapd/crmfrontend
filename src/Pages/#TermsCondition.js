                ...
                <Innerlayout>
                            ...
                            <Accordion className='pdf-terms-content'>
                                {
                                    <>
                                        ...
                                        <div className="form-check mb-4">
                                            ...
                                            <label className="form-check-label" htmlFor="exampleCheck2">I Accept
                                                Complaint Policy.</label>
                                        </div>
                                        ...
                                        <div className="form-check mb-4">
                                            ...
                                            <label className="form-check-label" htmlFor="exampleCheck4">I Accept Terms
                                                of Service.</label>
                                        </div>
                    ...
                    <div className="terms-content" style={{maxWidth: '100%'}}>
                        <div className='list-point'>
                            <ul>
                                <li>The Client has appointed CRM as the Client's agent for the purpose of
                                    dealing in Spot Contracts in accordance with the terms of the Client
                                    Acknowledgement, Disclosure Statement and the terms of the Client Agreement. which
                                    has been read, understood and agreed by the client.
                                </li>
                                ...
                                <li>The Client confirms that it does not have any pending litigation, disputed accounts
                                    or other unresolved matters whatsoever. If the Client does have any pending
                                    litigation, disputed accounts or other unresolved matters whatsoever then the Client
                                    must advise CRM in writing of such matters and CRM must
                                    consider such matters prior to approving the opening of the account.
                                </li>

                                <li>The Client acknowledges that all information provided in this format including all
                                    information pertaining to the Client in the Client Information section of this
                                    agreement is true and accurate. Further, the Client will immediately notify Park
                                    Money Ltd in writing if any representations materially change or cease to be true
                                    and accurate.
                                </li>
                        ...
                        <div className="form-check">
                            <input type="checkbox" className="form-check-input" id="accept_chk"
                                   onChange={() => setChecked(!checked)}/>
                            <label className="form-check-label" htmlFor="accept_chk">BY ACCEPTING, THE CLIENT AGREES TO
