...
const CreateTicket = (props) => {
    ...
    async function fetchData() {
        setLoading(true);
        CustomRequest('create-ticket', {}, client.token, (res)=> {
            if(res?.error) {
    ...
    const submitInput = async (e) => {
        ...
        CustomRequest('store-ticket', formData, client.token, (res)=> {
            if(res?.error) {
                console.log(res.error);
                                        ...
                                        <form onSubmit={submitInput}>
                                            ...
                                            <Form.Group className="mb-3">
                                                <Form.Group controlId="formFileMultiple" className="mb-3">
                                                    <Form.Control type="file" name='files' onChange={fileUpload}
                                                                  multiple/>
                                            ...
                                            <Form.Group className="mb-3">
                                                <select className="form-control select" name='priority'
                                                        value={ticketInput.priority} onChange={handleInput}>
                                            ...
                                            <Form.Group className="mb-4">
                                                <select className="form-control select" name='department'
                                                        value={ticketInput.department} onChange={handleInput}>
