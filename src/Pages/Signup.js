...
const Signup = (props) => {
    ...
    const [clientRefUrl, setClientRefUrl] = useState(hasClientRefCode);
    ...
    const signupSubmitHandler = (event) => {
        ...
        if (process.env.REACT_APP_ENV !== 'local') {
            if (captchastate === false) {
                ...
                const {first_name, last_name, city, email, password, referral_code, referer} = event.target.elements;
                    ...
                    <Col md={6} className="white-bg col">
                        <div className="content-box m-auto">
                            ...
                            <form onSubmit={signupSubmitHandler}>
                                ...
                                {props.type == 'ib' &&
                                    <Form.Group className="mb-3">
                                        <Form.Control type="text" name="referer" placeholder="Referer"/>
                                    </Form.Group>
                                } */}
                                {
                                    clientRefUrl === false && props.type !== 'ib' ?
                                        <div className="d-flex mb-3">
                                            ...
                                            <input style={{marginLeft: '10px'}} type="checkbox" id="referral_chk"
                                ...
                                <Form.Group className="mb-3">
                                    <Form.Control type="text" name="referral_code" id="referral_code"
                                ...
                                <div className="text-center mt-4 pt-3">Already have a account? <Link to="/login"
                                                                                                     className="link-text">Sign
                                    in</Link></div>
                                {
                                    (props.type === 'ib') ?
                                        <div className="text-center mt-1 pt-3">Want to become our client? <Link
                                            to="/signup" className="link-text">Click here</Link></div> :
                                        <div className="text-center mt-1 pt-3">Do you want to work as an IB? <Link
                                            to="/ib-signup" className="link-text">Click here</Link></div>
                                }
                            </form>
                        </div>
