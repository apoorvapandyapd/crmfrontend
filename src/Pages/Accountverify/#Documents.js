                    ...
                    {data.map((doc,i) =>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href={null} onClick={(e) => showModal(e, doc.document)}><img src={doc.document} height='50px' width='50px'></img></a>
                                {/* </Link> */}
                            </td>
                            ...
                            <td>
                                {
                                    doc.status === 'Rejected' ?
                                        <Link className="reupload-btn" to={{ pathname:'/update/document', state:{title: doc.title, image: doc.document} }}><Button className="btn btn-primary float-end btn-small">Reupload</Button></Link>
                                    :    <div></div>
                                }
                                {
                                    doc.status === 'Pending' ?
                                        <a href={null} onClick={(e) => deleteDocument(e, doc.id)} className="delete-icon"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
