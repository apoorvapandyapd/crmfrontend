...
import ClientCommissionHistory from '../IbDashboardPage/#ClientCommissionHistory';
                        ...
                        <div className="card-body ib-dashboard-content">
                            <ul className="c-tabs nav-tabs" id="myTab" role="tablist">
                                <li className="nav-item" role="presentation">
                                    <a className="active" id="c-tab" data-bs-toggle="tab" data-bs-target="#client-tab"
                                        role="tab" aria-controls="client-tab" aria-selected="false">IB Details</a>
                                </li>
                                <li className="nav-item" role="presentation">
                                    <a className="" id="sib-tab" data-bs-toggle="tab" data-bs-target="#live-accounts"
                                        role="tab" aria-controls="live-accounts" aria-selected="false">Client Details</a>
                                </li>
                            </ul>
                            <div className="tab-content" id="myTabContent">
                                ...
                                <div className="tab-pane fade" id="live-accounts" role="tabpanel"
                                    aria-labelledby="sib-tab" tabIndex="0">
