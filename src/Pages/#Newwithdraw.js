                    ...
                    <div className="box-wrapper w-700">
                        <div className="card-body create-ticket p-0 bg-white">
                            <h2 className="mb-0 px-40">
                                    <Link to='/withdrawrequest'><a href={null} className="back-arrow">
                                            ...
                                            <FormGroup className="mb-3">
                                                <Row>
                                                {
                                                    fieldData!==null && fieldData.map(val=>(
                                                        ...
                                                        {val.type !='textarea' ? 
                                                        <><label>{val.label}</label><input type={val.type} readOnly={true} className='form-control' name={val.key} id={val.key} value={value[val.key]} placeholder={val.label} onChange={handleInput} /></>
                                                        : <><label>{val.label}</label><FormControl as="textarea" value={value[val.key]} readOnly={true} name={val.key} rows={3} /></> }
