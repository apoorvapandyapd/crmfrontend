            ...
            <Col md={12} lg={6} xl={12}>
                <div className="card-body">
                    ...
                    <ul className="test-account">
                        <li>Demo Accounts <span style={{cursor: 'pointer'}}
                                                onClick={() => props.handleclick('demo')}>{props.data.data.demoList.length}</span>
                        </li>
                        <li>Live Accounts <span style={{cursor: 'pointer'}}
                                                onClick={() => props.handleclick('live')}>{props.data.data.liveList.length}</span>
                        </li>
                    </ul>
                </div>
            </Col>
            ...
            <Col md={12} lg={6} xl={12}>
                <div className="card-body">
                    ...
                    <ul className="get-touch">
                        <li><span>Submit Query</span><Link to="/create/ticket" className="link-text">Click Here</Link>
                        </li>
