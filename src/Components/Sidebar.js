    ...
    return (
        <div className="left-menu" id='leftMenu'>
            <div className="user-details">
                <span>
                     <Image src={`${process.env.PUBLIC_URL}/Images/logo-light.png`} alt="login" fluid
                ...
                <div className="user-name mt-4">
                    ...
                    <div className="content">
                        {client.client.first_name} {client.client.last_name}<span
                        style={{marginTop: '4px'}}>{(client.client.join_duration === "") ? 'Joined: Today' : `Joined: ${client.client.join_duration} ago`}</span>
                        <span
                            style={{marginTop: '4px'}}>KYC: {Array.isArray(client.client.verify) ? client.client.verify[0] : client.client.verify}</span>
                    </div>
                </div>
                {
                    (client.asIB === false || client.asIB === 'both') ?
                        <>
                            <Link to={{pathname: '/create/demo/account', state: {account: 'demo'}}}
                                  className="btn btn-primary btn-sm">Open Demo Account</Link>

                            <button disabled={disableLiveBtn} type="button" onClick={(e) => createLiveAccount(e)}
                                    className="btn btn-secondary btn-sm">Open Live Account
                            </button>
                ...
                (client.client.ib_status === false || client.client.ib_status === 'both') ?
                    <nav className="navbar">
                        <ul className="flex-column">
                            <li><Link to="/dashboard"
                                      className={curmenu === '/dashboard' ? 'active' : ''}><DashboardIcon width={24}
                                                                                                          height={24}/>Dashboard</Link>
                            </li>
                            {(client.client.form_terms_validation === 'completed' || client.client.verify === 'Completed') ?
                                <li>
                                    <Link className={curmenu === '/accountverification' ? 'active' : ''}
                            ...
                            <li>
                                <Link className={mtAccountUrl.includes(curmenu) ? 'active' : ''}
                                      to="/list/trading-accounts">
                            ...
                            <li style={display_status ? {opacity: '0.7'} : {}}>
                                <Link className={curmenu === '/mywallet' ? 'active' : ''}
                                      style={display_status ? {pointerEvents: 'none'} : {}} to="/mywallet">
                                    <WalletIcon width="24" height="24"/>
                                    My Wallet
                                </Link>
                            </li>
                            <li style={display_status ? {opacity: '0.7'} : {}}>
                                <Link className={curmenu === '/report/payment' ? 'active' : ''}
                                      style={display_status ? {pointerEvents: 'none'} : {}} to="/report/payment">
                            ...
                            </li>
                            {
                                (client.client.ib_status === 'both') ?
                                    <li className='dropdown' style={display_status ? {opacity: '0.7'} : {}}>
                                        <Link style={display_status ? {pointerEvents: 'none'} : {}} to="#"
                                              data-bs-toggle="collapse" data-bs-target="#join-partner"
                                              aria-expanded="true">
                                        ...
                                        <div
                                            className={`collapse ${(curmenu === '/ib/dashboard' || curmenu === '/ibmywallet' || curmenu === '/ib/client') ? 'show' : ''}`}
                                            id="join-partner">
                                            <ul className="sub-menu">
                                                <li><Link to="/ib/dashboard"
                                                          className={curmenu === '/ib/dashboard' || curmenu === '/ib/client' ? 'active' : ''}>IB
                                                    Dashboard</Link></li>
                                                {/* <li><Link to="/newibwithdraw" className={ curmenu === '/newibwithdraw' ? 'active' :''}>IB Withdraw</Link></li> */}
                                                <li><Link to="/ibmywallet"
                                                          className={curmenu === '/ibmywallet' ? 'active' : ''}>Commissions</Link>
                                                </li>
                                            </ul>
                                        </div>
                                    </li> : <li style={display_status ? {opacity: '0.7'} : {}}>
                                        <Link style={display_status ? {pointerEvents: 'none'} : {}} to="/becomeib"
                                              className={curmenu === '/becomeib' ? 'active' : ''}>
                            ...
                            <li className='dropdown' >
                                ...
                                <div
                                    className={`collapse ${(curmenu === '/ticket' || curmenu === '/show/ticket' || curmenu === '/faq') ? 'show' : ''}`}
                                    id="support">
                                    <ul className="sub-menu">
                                        <li><Link to="/ticket"
                                                  className={(curmenu === '/ticket' || curmenu === '/show/ticket') ? 'active' : ''}>Ticket</Link>
                                        </li>
                                        <li><Link to="/faq" className={curmenu === '/faq' ? 'active' : ''}>FAQ</Link>
                                        </li>
                    ...
                    <nav className="navbar">
                        <ul className="flex-column">
                            ...
                            <li style={display_status ? {opacity: '0.7'} : {}}>
                                <Link style={display_status ? {pointerEvents: 'none'} : {}} to="/ib/dashboard"
                                      className={curmenu === '/ib/dashboard' || curmenu === '/ib/client' ? 'active' : ''}>
                            ...
                            <li style={display_status ? {opacity: '0.7'} : {}}>
                                <Link className={curmenu === '/ibmywallet' ? 'active' : ''}
                                      style={display_status ? {pointerEvents: 'none'} : {}} to="/ibmywallet">
                                    <WalletIcon width="24" height="24"/>
                                    My Wallet
                                </Link>
                            </li>
